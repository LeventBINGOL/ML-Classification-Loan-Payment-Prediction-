...
# This project solves loan payment prediction with several classification algorithms with several accuracy and evaluation levels. I use the following machine Learning algorithms with Python to get insight on the issue. 
